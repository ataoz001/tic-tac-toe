...
Yapilacaklarin hepsi:

Islinear adinda bir fonksiyon yazilacak ve icine tuple olarak uc tane nokta gonderip bunlarin ayni dogruda olup olmadigi kontrol edilecek
kullanici cevaplarindan kordinatlri tupple seklinde temizleyecek bir fonskiyon yazilacak
bu islinerara map(islinear, [[(),(),()],[(),(),()]]) sekilinde atilacak o yandaki ucluler de aslinda tum kombinasyonlardan gelecek 3'luleri aliyoruz bunun icinde nested for loop kullanicaz diye dusunuyorum
...
class Board():
    ...
    def update_ui(self,string,current_board_matrix):
        ...
        string = string.format(cbm[0],cbm[1],cbm[2],cbm[3],cbm[4],cbm[5],cbm[6],cbm[7],cbm[8])
        return string
        ...
        while flag:
            if game_turns % 2 == 0:
                ...
                if temp == board.matrix:
                    print("You have entered a tile that was already filled\nPlease select another one.")
